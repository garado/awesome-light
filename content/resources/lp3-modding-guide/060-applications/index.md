...
3. Search for '**Aurora Store**' or type in the following link: [https://auroraoss.com/files](https://auroraoss.com/files)
    - Dir: `/ downloads / AuroraStore / Release`
...
[Obtainium](https://obtainium.imranr.dev/) is not _absolutely_ necessary but is incredibly useful in keeping applications updated that were sourced from the GitHub repos directly.
...
All community-made tools for the LP3 are recommended to be downloaded via Obtainium as this will allow them to stay updated frequently as developers frequently push out new fixes and releases. A list of current community-made Light tools can be found **[HERE](#community-made-light-tools)**.
...
The .apk for microG (formerly known as revanced) can be found [here via vanced](https://vanced.to/gmscore-microg).
...
inkOS can be downloaded [here via GitHub](https://github.com/gezimos/inkOS/releases).
...
- **Molly Light** (jabberbox)
    ...
    - [Source](https://github.com/jabberbox/molly-light)
...
- **Passatempo** (tyshi00)
    ...
    - [Source](https://github.com/tyshi00/Light-Games-Passatempo)
    - [Download](https://github.com/tyshi00/Light-Games-Passatempo/releases)
...
- **Unofficial Light Phone API/CLI/TUI** (garado)
    ...
    - [Source](https://github.com/garado/light)
...
- **Emojis** (zacksimpson)
    ...
    - [Source](https://github.com/zacksimpson/emoji-tool)
...
- **Keyboard** (adam-weber)
    ...
    - [Source](https://github.com/adam-weber/light-keyboard)
    - [Download](https://github.com/adam-weber/light-keyboard/releases)
- **Type** (KEZO555)
    ...
    - [Source](https://github.com/KEZO555/Type)
...
- **Luma** (vandamd)
    ...
    - [Source](https://github.com/vandamd/luma)
    - [Download](https://github.com/vandamd/luma/releases)
...
- **Bard** (sjkornelsen)
    ...
    - [Source](https://github.com/sjkornelsen/bard)
    - [Download](https://github.com/sjkornelsen/bard/releases)
- **Echo** (vandamd)
    - A minimal Spotify client for the Light Phone III that requires Spotify to be installed locally on the device.
    - [Source](https://github.com/vandamd/echo)
    - [Download](https://github.com/vandamd/echo/releases)
- **NTS Radio** (vandamd)
    - An app to play NTS Radio Live shows and Infinite Mixtapes.
    - [Source](https://github.com/vandamd/nts-radio)
    - [Download](https://github.com/vandamd/nts-radio/releases)
- **Phono** (jonathancaudill)
    ...
    - [Source](https://github.com/jonathancaudill/phono)
    - [Download](https://github.com/jonathancaudill/phono/releases)
- **Reverb** (vandamd)
    ...
    - [Source](https://github.com/vandamd/reverb)
    - [Download](https://github.com/vandamd/reverb/releases)
- **Tunes** (dryane)
    - A minimal music app for the Light Phone III with automatic music detection.
    - [Source](https://github.com/dryane/light-music)
    - [Download](https://github.com/dryane/light-music/releases)
...
- **Buses** (vandamd)
    ...
    - [Source](https://github.com/vandamd/buses)
    - [Download](https://github.com/vandamd/buses/releases)
- **Topographic** (garado)
    ...
    - [Source](https://github.com/garado/light-topographic)
    - [Download](https://github.com/garado/light-topographic/releases)
...
- **Zero** (vandamd)
    ...
    - [Source](https://github.com/vandamd/zero)
    - [Download](https://github.com/vandamd/zero/releases)
- **Photo Backup** (sjkornelsen)
    ...
    - [Source](https://github.com/sjkornelsen/light-photo-backup-public)
    - [Download](https://github.com/sjkornelsen/light-photo-backup-public/releases)

### Productivity

- **Checklist** (ak-nattyb)
    - A simple checklist app with list-based organization for Light Phone users with Markdown capability and colour inversion.
    - [Source](https://github.com/ak-nattyb/Checklist)
    - [Download](https://github.com/ak-nattyb/Checklist/releases)
- **Composer** (zacksimpson)
    - A notes tool for the Light Phone III with Markdown capabilities.
    - [Source](https://github.com/zacksimpson/composer-tool)
    - [Download](https://github.com/zacksimpson/composer-tool/releases)
- **Luminous Strategies** (ak-nattyb)
    ...
    - [Source](https://github.com/ak-nattyb/Luminous-Strategies)
    - [Download](https://github.com/ak-nattyb/Luminous-Strategies/releases)
- **Recall** (ChopinDavid) — _UNRELEASED_
    ...
    - [Source](https://github.com/ChopinDavid/recall-lightos)
...
- **Reminders** (zacksimpson)
    ...
    - [Source](https://github.com/zacksimpson/reminders-tool)
    - [Download](https://github.com/zacksimpson/reminders-tool/releases)
...
- **Backlog** (Alexis-NM)
    ...
    - [Source](https://github.com/Alexis-NM/light-backlog)
...
- **Bible** (cmg-ops)
    ...
    - [Source](https://github.com/cmg-ops/LP3-Bible)
...
- **Bible** (greghare)
    ...
    - [Source](https://github.com/greghare/light-bible)
...
- **Botany** (greghare)
    ...
    - [Source](https://github.com/greghare/light-botany)
...
- **Dictionary** (garado)
    ...
    - [Source](https://github.com/garado/dictionary)
...
- **Light GPSLogger** (garado)
    ...
    - [Source](https://github.com/garado/light-gpslogger)
...
- **Lists** (cmg-ops)
    ...
    - [Source](https://github.com/cmg-ops/LP3-Lists)
...
- **MediLight** (ruditimmermans)
    ...
    - [Source](https://github.com/ruditimmermans/LightMedication)
...
- **Metronome** (garado)
    ...
    - [Source](https://github.com/garado/metronome)
    - [Download](https://github.com/garado/metronome/releases)
- **Nourish** (zacksimpson)
    - A mindfulness-first daily check-in tool and meal logger for the Light Phone III.
    - [Source](https://github.com/zacksimpson/nourish-tool)
...
- **Paka** (janovsk1s)
    ...
    - [Source](https://github.com/janovsk1s/paka)
    - [Download](https://github.com/janovsk1s/paka/releases)
- **Passes** (vandamd)
    ...
    - [Source](https://github.com/vandamd/passes)
    - [Download](https://github.com/vandamd/passes/releases)
- **Pokey** (jabberbox)
    ...
    - [Source](https://github.com/jabberbox/pokey)
...
- **Ritual** (KEZO555)
    ...
    - [Source](https://github.com/KEZO555/Ritual)
    - [Download](https://github.com/KEZO555/Ritual/releases)
- **StopWatch** (cmg-ops)
    - A stopwatch tool for the Light Phone III that has laps, best/slowest lap tracking and a history of past sessions.
    - [Source](https://github.com/cmg-ops/LP3-StopWatch)
    - [Download](https://github.com/cmg-ops/LP3-StopWatch/releases)
- **Strings** (garado)
    - A minimal chromatic tuner for the Light Phone III with an adjustable reference pitch and adjustable note display.
    - [Source](https://github.com/garado/strings)
    - [Download](https://github.com/garado/strings/releases)
- **Tracker** (tyshi00)
    ...
    - [Source](https://github.com/tyshi00/Tracker)
...
- **Verses** (zacksimpson)
    ...
    - [Source](https://github.com/zacksimpson/verses-tool)
    - [Download](https://github.com/zacksimpson/verses-tool)
- **Weather** (vandamd)
    ...
    - [Source](https://github.com/vandamd/weather)
    - [Download](https://github.com/vandamd/weather/releases)
...
- Brave (via Aurora)
- Mozilla Firefox (alternatives include [IronFox](https://github.com/ironfox-oss/IronFox) and Fennec) (via Aurora for Fennec or via GitHub for IronFox)
