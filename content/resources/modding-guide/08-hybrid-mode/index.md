...
If you want to have full access to Wi-Fi / Bluetooth connections, you MUST enable `light_mode` in order to connect Bluetooth and Wi-Fi on Hybrid Mode. Click **HERE** to enable `light_mode`.
