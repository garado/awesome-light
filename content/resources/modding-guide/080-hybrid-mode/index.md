...
If you want to have full access to Wi-Fi / Bluetooth connections, you MUST enable `light_mode` in order to connect Bluetooth and Wi-Fi on Hybrid Mode. Click **[HERE](/resources/modding-guide/full-android/#global-setting-light_mode)** to enable `light_mode`.
...
- [Applications](/resources/modding-guide/applications/)
- [Launchers](/resources/modding-guide/applications/#launchers)
- [Additional Applications](/resources/modding-guide/applications/#additional-applications)
- [Key Mapper](/resources/modding-guide/key-maps-and-macros/#key-mapper)
- [Recreating LightOS Key Maps](/resources/modding-guide/key-maps-and-macros/#recreating-lightos-button-functionality)
- [Hybrid Mode Specific Key Maps](/resources/modding-guide/key-maps-and-macros/#hybrid-mode-specific-key-maps)
- [MacroDroid](/resources/modding-guide/key-maps-and-macros/#macrodroid)
- [Hybrid Mode Specific Macros](/resources/modding-guide/key-maps-and-macros/#hybrid-mode-specific-macros)
- [Call Handling](/resources/modding-guide/key-maps-and-macros/#call-handling)
- [Notification Handling](/resources/modding-guide/key-maps-and-macros/#notification-handling)
- [Battery Optimisation](/resources/modding-guide/additional-guides/#battery-optimisation)
